...
export default function Dashboard() {
  ...
  const _doneCount = realTasks.filter((t) => t.status === 'done').length
  ...
  const _financeSeries = useMemo(() => buildSeries(financeEntries, financePeriod, (item) => {
              ...
              >
                <div className="ds-dashboard-project-row">
                  <div className="ds-dashboard-project-left">
                    <div className="ds-dashboard-project-name">{project.name}</div>
                    <div className="ds-dashboard-project-meta">
                      <span className="ds-dashboard-project-income">+{income.toLocaleString()} IRR</span>
                      <span className="ds-dashboard-project-expense">-{expense.toLocaleString()} IRR</span>
                    </div>
                  </div>
                  <div className="ds-dashboard-project-right">
                    <div className={`ds-dashboard-project-value ${balance >= 0 ? 'ds-dashboard-value-positive' : 'ds-dashboard-value-negative'}`}>
                      {balance >= 0 ? "+" : "-"}
                      {Math.abs(balance).toLocaleString()} IRR
                    </div>
      ...
      >
        ...
        <div className="finance-row">
          <div className="finance-item">
            <span>Income</span>
            <strong className="positive">+{totals.income.toLocaleString()} IRR</strong>
          </div>
          <div className="finance-item">
            <span>Expense</span>
            <strong className="negative">-{totals.expense.toLocaleString()} IRR</strong>
          </div>
          <div className="finance-item">
            <span>Balance</span>
